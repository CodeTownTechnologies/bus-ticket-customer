...
export default class BookingDetail extends Component {
  ...
  renderTopView() {
    ...
    console.log(arrival_terminal_name, departure_terminal_name);
      ...
      <View style={styles.topView}>
        ...
        <View style={styles.brownView}>
          <View style={AppStyles.rowCenterView}>
            ...
            <View>
              <Text14
                type="regular"
                title={trip_route_name.split('-')[0]}
                addStyle={styles.departure}
              />
              <Text14
                type="regular"
                title={trip_route_name.split('-')[1]}
        ...
        <View style={styles.topWhiteView}>
          <View style={styles.tripDataCont}>
            ...
            {this.renderTripData(
              'Ticket',
              this.props.route.params.fromFlow == 'Subscription'
                ? 'Subscription'
                : 'Single Trip',
            )}
          </View>
      ...
      <View style={styles.bottomView}>
        ...
        <TouchableOpacity>
          <Text12
            ...
            type="light"
            addStyle={{color: Colors.green27, alignSelf: 'center'}}
          />
        </TouchableOpacity>
        <AppButton
          type={'withoutContainer'}
          ...
          buttonPressed={() => {
            this.props.navigation.navigate('subscriptionPackage', {
              ...this.props.route.params,
            });
          }}
          containerStyle={styles.subscriptionBtn}
        />
        <AppButton
          type={'withoutContainer'}
          title={'Next'}
