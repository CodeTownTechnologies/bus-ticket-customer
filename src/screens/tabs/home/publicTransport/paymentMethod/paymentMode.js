...
import { Header, PaymentTypes, AppButton, Text14, Text16 } from '../../../../../components';
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <AppButton type={"withoutContainer"} disable={!paymentType} title={"Next"} buttonPressed={() => this.props.navigation.navigate('PaymentDetails', { ...this.props.route.params, paymentType: paymentType})} containerStyle={{ marginTop: 0 }} />
            </View>
        );
    }
}
