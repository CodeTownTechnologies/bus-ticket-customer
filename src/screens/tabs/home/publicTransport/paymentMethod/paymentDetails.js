...
export default class PaymentDetails extends Component {
  ...
  buyPressed() {
    ...
    this.props.navigation.navigate('creditCard', {
      price,
      completeTransaction: this.bought,
    });
  }

  bought = (tokenid, authid, cvv) => {
    const {trip_id, price, departureDate} = this.props.route.params;
    console.log(
      JSON.stringify(this.props.route.params, null, 2),
      'ROUTE PARAMS',
    );
    ...
    api.home.createBooking(data).then((res) => {
  ...
  renderSuccessModal() {
    return (
      <Modal visible={this.state.ticketSuccessModal} transparent>
        <View
          style={{
            flex: 1,
          ...
          <View
            ...
            <Image
              ...
              style={{height: 53, width: 53, marginVertical: 25}}
            />
            <AppButton
      ...
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <View style={{marginHorizontal: 30}}>
          <View>
            <Text14
              type="regular"
              title={this.props.route.params.paymentType}
            />
          </View>
          <View
            style={{
          ...
          <AppButton
            type={'withoutContainer'}
            // title={'Pay with ' + this.props.route.params.paymentType}
            title={'Pay'}
            buttonPressed={() => this.buyPressed()}
            containerStyle={{}}
          />
        </View>
      </View>
